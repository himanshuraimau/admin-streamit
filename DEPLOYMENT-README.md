...
- **`nginx-configs/`** - Nginx configuration templates
  - `api.vidrelay.site.conf` - Backend API configuration
  - `app.vidrelay.site.conf` - Frontend app configuration
...
```
app.vidrelay.site → <Your-EC2-IP>
api.vidrelay.site → <Your-EC2-IP>
```
...
```bash
# Copy Nginx configs
sudo cp ~/streamit-admin/nginx-configs/api.vidrelay.site.conf /etc/nginx/sites-available/
sudo cp ~/streamit-admin/nginx-configs/app.vidrelay.site.conf /etc/nginx/sites-available/

# Enable sites
sudo ln -s /etc/nginx/sites-available/api.vidrelay.site.conf /etc/nginx/sites-enabled/
sudo ln -s /etc/nginx/sites-available/app.vidrelay.site.conf /etc/nginx/sites-enabled/
...
- **Health Check**: https://api.vidrelay.site/health
